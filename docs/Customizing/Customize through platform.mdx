...
- **Favicon**  The small icon associated with the website, which typically appears on the browser tabs, bookmarks, and the address bar.
...
The theme customization controls the visual style of your published website, including:
...
| Setting         | Description                                                                                                              |
| --------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Display footer  | Display or hide the footer                                                                                               |
| Logo            | Uplode a custom logo that reflects your own branding. You need to set the light and dark mode logos seperately.          |
| Logo URL        | Link to navigate to when the logo is clicked.                                                                            |
