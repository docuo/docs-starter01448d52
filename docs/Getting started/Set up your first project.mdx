...
To get started with Docuo, you need to create a personal account and verify your email address. You can also directly sign up with your Google account.
If you have already signed up with an account, log in to continue with Docuo!
...
Hit "Sign in with GitHub" to Connect your GitHub account first. It will ask to install Docuo OAuth app to your GitHub account. After this, Docuo has read and write permissions to the repository where the documents are located.
<Frame width="auto" height="auto" >
...
Hit "Create", Docuo public template repository will be cloned to your own GitHub account, which you can find in your GitHub repository list.
...
## Visit your first project's website
