...
Docuo supports third-party data ananlytics intergration, [Google Analytics 4](https://support.google.com/analytics/answer/10089681), to help you receive Docuo insihghts about your visitors and customer usage of your published documentation.
...
When you sign up for Google Analytics, you'll enter the dashboard homepage. You can find the data stream page via search box.
